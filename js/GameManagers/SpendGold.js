    ...
    setBuyText: function() {
        game.data.buyText = new (me.Renderable.extend({
            ...
            draw: function(renderer) {
                ...
                this.font.draw(renderer.getContext(), "Skill 2: Rnun Faster, Current Level:" + game.data.skill2 + " Cost:" + ((game.data.skill2 + 1) * 10), this.pos.x, this.pos.y + 80);
                this.font.draw(renderer.getContext(), "Skill 3: Increase , Level:" + game.data.skill3 + " Cost:" + ((game.data.skill3 + 1) * 10), this.pos.x, this.pos.y + 120);
